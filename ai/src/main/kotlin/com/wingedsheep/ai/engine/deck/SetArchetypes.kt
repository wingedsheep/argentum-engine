...
object SetArchetypes {
    ...
    private val allSets: Map<String, SetSynergies> = mapOf(
        ...
        "DFT" to SetSynergies(
            ...
            setName = "Aetherdrift",
            archetypes = listOf(
                Archetype("Artifact Value", listOf(Color.WHITE, Color.BLUE),
                    "Build a broad board of artifact creatures and Vehicles, then turn that artifact density into discounts and repeated value. A patient control deck that eventually overwhelms opponents with its assembled fleet."),
                Archetype("Artifact Bleeder", listOf(Color.BLUE, Color.BLACK),
                    "Gum up the battlefield with artifact creatures, Toys, and Thopters while artifact payoffs steadily drain the opponent. A controlling attrition deck that wins a life point at a time."),
                Archetype("Max Speed Aggro", listOf(Color.BLACK, Color.RED),
                    "Attack early and keep dealing damage to reach max speed, upgrading efficient attackers into dangerous finishers. The color pair's low curve and direct damage keep the pressure relentless."),
                Archetype("Exhaust Midrange", listOf(Color.RED, Color.GREEN),
                    "Use exhaust abilities for one decisive burst of value, with cost reducers helping activate the strongest abilities ahead of schedule. A creature-heavy midrange deck whose racers grow to dominating size."),
                Archetype("Vehicles and Mounts Midrange", listOf(Color.GREEN, Color.WHITE),
                    "Balance creatures with Vehicles and Mounts so every ride has someone ready to crew or saddle it. Combat bonuses reinforce the team after attacking, creating a sturdy go-tall midrange deck."),
                Archetype("Max Speed Attrition", listOf(Color.WHITE, Color.BLACK),
                    "Build speed through sacrifice, life drain, and evasive chip damage instead of all-out attacks. Removal and recursive value let this slower max-speed deck clear a path and grind opponents down."),
                Archetype("Discard Aggro", listOf(Color.BLUE, Color.RED),
                    "Cycle and discard cards to trigger aggressive payoffs while continuously improving the quality of your hand. Instant-speed cycling keeps options open before an explosive tempo turn."),
                Archetype("Graveyard", listOf(Color.BLACK, Color.GREEN),
                    "Mill or discard expensive creatures and Vehicles, then reanimate them ahead of schedule. Self-mill and recursion form a five-cylinder value engine that turns the graveyard into a second hand."),
                Archetype("Vehicles and Mounts Aggro", listOf(Color.RED, Color.WHITE),
                    "Deploy cheap creatures, Vehicles, and Mounts, then use token generation and combat payoffs to hit fast and hard. This is the format's most dedicated racing deck, built to stay on the attack."),
                Archetype("Exhaust Ramp", listOf(Color.GREEN, Color.BLUE),
                    "Ramp with lands and mana artifacts so you can activate multiple expensive exhaust abilities. Card advantage and oversized finishers reward taking the long route and going over the top."),
            )
        ),
        "INR" to SetSynergies(
            setCode = "INR",
            ...
            archetypes = listOf(
                Archetype("Spirits Tempo", listOf(Color.WHITE, Color.BLUE),
                    "Build an evasive Spirit army and protect its clock with bounce, tap effects, and other disruption. Tribal payoffs turn a steady stream of flyers into a fast tempo deck.",
                    creatureTypes = listOf("Spirit")),
                Archetype("Zombies", listOf(Color.BLUE, Color.BLACK),
                    "Trade resources, fill the graveyard, and recur or multiply Zombies for long-game value. Efficient removal and card advantage let the tribe play a controlling midrange game.",
                    creatureTypes = listOf("Zombie")),
                Archetype("Vampires / Madness", listOf(Color.BLACK, Color.RED),
                    "Discard cards for value, cast madness spells at a discount, and use Blood-style rummaging to keep the engine moving. Vampire payoffs add pressure to this aggressive midrange plan.",
                    creatureTypes = listOf("Vampire")),
                Archetype("Werewolves", listOf(Color.RED, Color.GREEN),
                    "Curve into oversized Werewolves and transform them into dominant attackers. Combat tricks and efficient removal help this stompy deck keep applying pressure.",
                    creatureTypes = listOf("Werewolf", "Wolf")),
                Archetype("Humans / Tokens", listOf(Color.GREEN, Color.WHITE),
                    "Develop a wide board of Humans and creature tokens, then grow the team with counters and mass-pump effects. A strong curve lets the deck attack early and scale into the midgame.",
                    creatureTypes = listOf("Human")),
                Archetype("Aristocrats", listOf(Color.WHITE, Color.BLACK),
                    "Create expendable bodies and sacrifice them for cards, removal, and drain effects. Recursive creatures and Spirit tokens make every trade advance a patient attrition plan."),
                Archetype("Spells", listOf(Color.BLUE, Color.RED),
                    "Combine cheap instants and sorceries with spells-matter threats, flashback, and token makers. Choose a lean tempo build or a slower control shell, then keep its spell density high."),
                Archetype("Morbid / Graveyard", listOf(Color.BLACK, Color.GREEN),
                    "Enable morbid through combat and sacrifice while stocking the graveyard for recursion and creature-count payoffs. Removal and resilient threats support a grindy midrange game."),
                Archetype("Aggro / Tokens", listOf(Color.RED, Color.WHITE),
                    "Flood the board with efficient creatures and tokens, then force damage through with combat tricks, tap effects, and team-wide bonuses. Prioritize a low curve and sustained pressure."),
                Archetype("Self-Mill", listOf(Color.GREEN, Color.BLUE),
                    "Mill creatures and flashback spells into the graveyard, then convert the stocked graveyard into oversized threats and recursive value. Splashing graveyard payoffs can reward careful fixing."),
            )
        ),
        "FDN" to SetSynergies(
            setCode = "FDN",
