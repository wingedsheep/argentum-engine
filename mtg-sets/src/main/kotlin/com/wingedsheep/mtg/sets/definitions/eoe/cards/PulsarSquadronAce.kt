...
val PulsarSquadronAce = card("Pulsar Squadron Ace") {
    ...
    triggeredAbility {
        ...
        effect = Effects.Pipeline {
            ...
            // The ifNotEmpty branch is an empty composite (do-nothing), which the builder's
            // ifNotEmpty { } cannot express (it requires a non-empty body), so the whole
            // ConditionalOnCollectionEffect is carried verbatim via run() — byte-identical.
            run(
