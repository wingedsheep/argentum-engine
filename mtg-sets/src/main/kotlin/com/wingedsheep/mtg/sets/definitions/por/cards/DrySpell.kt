...
val DrySpell = card("Dry Spell") {
    ...
    spell {
        effect = Effects.ForEachInGroup(GroupFilter.AllCreatures, DealDamageEffect(1, EffectTarget.Self)) then Effects.DealDamage(1, EffectTarget.PlayerRef(Player.Each))
    }
