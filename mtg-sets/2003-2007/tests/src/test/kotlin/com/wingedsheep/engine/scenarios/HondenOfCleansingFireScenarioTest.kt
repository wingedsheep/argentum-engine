...
/**
 * Honden of Cleansing Fire (CHK #14) — "At the beginning of your upkeep, you gain 2 life for each Shrine you control."
 *
 ...
 */
class HondenOfCleansingFireScenarioTest : ScenarioTestBase() {
    ...
    private fun board(extraShrine: Boolean) = scenario()
        ...
        .withCardOnBattlefield(1, "Honden of Cleansing Fire")
    ...
    init {
        context("Honden of Cleansing Fire") {
