...
data class EnvConfig(
    ...
    /**
     * Which player's information-set the default [com.wingedsheep.engine.gym.contract.TrainingObservation]
...
/** A single environment's `step()` input — batched into [com.wingedsheep.engine.gym.service.MultiEnvService.stepBatch]. */
@Serializable
