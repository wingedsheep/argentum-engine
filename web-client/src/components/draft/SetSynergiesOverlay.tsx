    ...
    archetypes: [
      {
        ...
        keyCard: 'Battleground Geist',
        description: 'Build an evasive Spirit army and protect its clock with bounce, tap effects, and other disruption. Tribal payoffs turn a steady stream of flyers into a fast tempo deck.',
      },
      {
        name: 'Zombies',
        colors: ['U', 'B'],
        creatureTypes: ['Zombie'],
        keyCard: 'Bladestitched Skaab',
        description: 'Trade resources, fill the graveyard, and recur or multiply Zombies for long-game value. Efficient removal and card advantage let the tribe play a controlling midrange game.',
      },
      {
        name: 'Vampires / Madness',
        colors: ['B', 'R'],
        creatureTypes: ['Vampire'],
        keyCard: 'Bloodtithe Harvester',
        description: 'Discard cards for value, cast madness spells at a discount, and use Blood-style rummaging to keep the engine moving. Vampire payoffs add pressure to this aggressive midrange plan.',
      },
      {
        name: 'Werewolves',
        colors: ['R', 'G'],
        creatureTypes: ['Werewolf', 'Wolf'],
        keyCard: 'Howlpack Resurgence',
        description: 'Curve into oversized Werewolves and transform them into dominant attackers. Combat tricks and efficient removal help this stompy deck keep applying pressure.',
      },
      {
        name: 'Humans / Tokens',
        colors: ['G', 'W'],
        creatureTypes: ['Human'],
        keyCard: 'Join the Dance',
        description: 'Develop a wide board of Humans and creature tokens, then grow the team with counters and mass-pump effects. A strong curve lets the deck attack early and scale into the midgame.',
      },
      {
        name: 'Aristocrats',
        colors: ['W', 'B'],
        keyCard: 'Fleshtaker',
        description: 'Create expendable bodies and sacrifice them for cards, removal, and drain effects. Recursive creatures and Spirit tokens make every trade advance a patient attrition plan.',
      },
      {
        name: 'Spells',
        colors: ['U', 'R'],
        keyCard: 'Wandering Mind',
        description: 'Combine cheap instants and sorceries with spells-matter threats, flashback, and token makers. Choose a lean tempo build or a slower control shell, then keep its spell density high.',
      },
      {
        name: 'Morbid / Graveyard',
        colors: ['B', 'G'],
        keyCard: 'Grizzly Ghoul',
        description: 'Enable morbid through combat and sacrifice while stocking the graveyard for recursion and creature-count payoffs. Removal and resilient threats support a grindy midrange game.',
      },
      {
        name: 'Aggro / Tokens',
        colors: ['R', 'W'],
        keyCard: 'Markov Waltzer',
        description: 'Flood the board with efficient creatures and tokens, then force damage through with combat tricks, tap effects, and team-wide bonuses. Prioritize a low curve and sustained pressure.',
      },
      {
        name: 'Self-Mill',
        colors: ['G', 'U'],
        keyCard: 'Vilespawn Spider',
        description: 'Mill creatures and flashback spells into the graveyard, then convert the stocked graveyard into oversized threats and recursive value. Splashing graveyard payoffs can reward careful fixing.',
      },
    ],
  },
  FDN: {
