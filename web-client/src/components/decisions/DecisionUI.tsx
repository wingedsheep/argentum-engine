...
import type { EntityId, SelectCardsDecision, ChooseTargetsDecision, YesNoDecision, ChooseNumberDecision, ChooseOptionDecision, ChooseColorDecision, SelectManaSourcesDecision, ClientCard, ClientGameState } from '../../types'
