/**
 * Targeting and selection color constants.
 * These mirror the CSS variables in variables.css for use in inline styles.
...
export const SELECTED_BG = '#0a2a1a'
export const SELECTED_GLOW = 'rgba(68, 221, 68, 0.8)'
export const SELECTED_SHADOW = 'rgba(68, 221, 68, 0.4)'
