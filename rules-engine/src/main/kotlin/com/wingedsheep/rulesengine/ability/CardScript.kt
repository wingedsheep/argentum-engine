...
/**
 * Helper value class to reference a specific target requirement index.
 */
@JvmInline
...
class CardScriptBuilder(private val cardName: String) {
    ...
    /**
     * Define targets for the spell/ability.
     * Returns a Reference that can be passed to Effects to bind them to this specific choice.
     */
