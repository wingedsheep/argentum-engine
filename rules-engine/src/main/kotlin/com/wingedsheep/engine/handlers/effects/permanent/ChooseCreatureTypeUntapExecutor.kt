...
/**
 * Executor for ChooseCreatureTypeUntapEffect.
 *
 ...
 * 3. On resume, untaps all creatures of the chosen type
 */
class ChooseCreatureTypeUntapExecutor : EffectExecutor<ChooseCreatureTypeUntapEffect> {

    override val effectType: KClass<ChooseCreatureTypeUntapEffect> =
        ChooseCreatureTypeUntapEffect::class
    ...
    override fun execute(
        ...
        val continuation = ChooseCreatureTypeUntapContinuation(
