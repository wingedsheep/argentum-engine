...
val engineSerializersModule = SerializersModule {
    ...
    polymorphic(ContinuationFrame::class) {
        ...
        subclass(SurveilContinuation::class)
        ...
        subclass(PreventDamageChainCopyDecisionContinuation::class)
        subclass(PreventDamageChainCopyLandContinuation::class)
        subclass(PreventDamageChainCopyTargetContinuation::class)
